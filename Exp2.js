...
var welcome = {
  ...
  var ins1 = {
    ...
    pages: function () {
        ...
        return [
          start + 
          `<p class='footer' style='font-size: 30px; line-height: 35px;'>请您判断屏幕中的几何图形是否与“自我”匹配，</p><p class='footer' style='color:white; font-size: 25px;'>如果 匹配 ，请按<span style="color: lightgreen; font-size:25px">与“自我”同侧的按键</span></p><p class='footer' style='color:white; font-size: 25px;'>如果 不匹配 ，请按<span style="color: lightgreen; font-size:25px">与“其他”同侧的按键</p></span><p class='footer' style='color:white; font-size: 20px;'>请在实验过程中将您的<span style="color: lightgreen;">食指</span>放在电脑键盘的相应键位上准备按键。</p></span>`
          + end];
      },
    show_clickable_nav: true,
    button_label_previous: " <span class='add_' style='color:black; font-size: 20px;'> 返回</span>",
  ...
  let prac_1 = {
    ...
    stimuli:[
        ...
        },*/
        {
          ...
          content: function () {
            return jsPsych.timelineVariable('word3', true)();//记得后面要加括号
          },
        ...
        }, //上一组end时间减去下一组show时间就是空屏的100ms
        {
          ...
          startY: -250, //图形和文字距离 与加号等距
          content: function () {
            return jsPsych.timelineVariable('word2', true)();//记得后面要加括号
          },
          font: `${80}px 'Arial'`, //字体和颜色设置 文字视角：3.6° x 1.6°
    ...
    },
    {
        ...
        timeline_variables:[
            {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[1]}, word2: function(){return text2_Z[0]}, word3:function(){return text2_Z[1]}},
            {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[0]}, word2: function(){return text2_Z[1]}, word3:function(){return text2_Z[0]}},
            {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[1]}, word2: function(){return text2_Z[1]}, word3:function(){return text2_Z[0]}},
            {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[0]}, word2: function(){return text2_Z[0]}, word3:function(){return text2_Z[1]}}, 
            {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[1]}, word2: function(){return text2_Z[1]}, word3:function(){return text2_Z[0]}},
            {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[0]}, word2: function(){return text2_Z[0]}, word3:function(){return text2_Z[1]}},
    ...
    var if_node1 = { //if_node 用于判断是否呈现feedback，feedback_continue_practice
        timeline: [feedback_gop, feedback_continue_practice1],
        ...
        timeline:[
          {
            ...
            timeline_variables:[
            {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[1]}, word2: function(){return text2_P[1]}, word3:function(){return text2_P[0]}},
            {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[0]}, word2: function(){return text2_P[0]}, word3:function(){return text2_P[1]}},
            {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[1]}, word2: function(){return text2_P[0]}, word3:function(){return text2_P[1]}},
            {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[0]}, word2: function(){return text2_P[1]}, word3:function(){return text2_P[0]}}, 
            {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[1]}, word2: function(){return text2_P[1]}, word3:function(){return text2_P[0]}},
            {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[0]}, word2: function(){return text2_P[0]}, word3:function(){return text2_P[1]}},
            ],
            randomize_order:true,
            repetitions:4,//正是实验时改为6
            on_finish:function(){
                // $("body").css("cursor", "default"); //鼠标出现
            }
         }
        ...
        var if_node2 = { //if_node 用于判断是否呈现feedback，feedback_continue_practice
          ...
          let prac_3 = {
            ...
            },
            {
                ...
                timeline_variables:[
                  {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[1]}, word2: function(){return text2_S[1]}, word3:function(){return text2_S[0]}},
                  {Image:function(){return images[0]}, word:texts[0],identify:function(){return key[0]}, word2: function(){return text2_S[0]}, word3:function(){return text2_S[1]}},
                  {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[1]}, word2: function(){return text2_S[1]}, word3:function(){return text2_S[0]}},
                  {Image:function(){return images[1]}, word:texts[1],identify:function(){return key[0]}, word2: function(){return text2_S[0]}, word3:function(){return text2_S[1]}}, 
                  {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[1]}, word2: function(){return text2_S[0]}, word3:function(){return text2_S[1]}},
                  {Image:function(){return images[2]}, word:texts[2],identify:function(){return key[0]}, word2: function(){return text2_S[1]}, word3:function(){return text2_S[0]}},
                ],
                randomize_order:true,
                repetitions:4,
                on_finish:function(){
            ...
            timeline_variables:[
             ...
             let feedback_block = {
              ...
              let blockTotalNum_Z = 3;// 此处填入总block数量-1，比如总数量是3，那么值就需要是2
              let rest_self = {
              type:jsPsychHtmlButtonResponse,
              stimulus: function () {
            ...
            let rest_stranger = {
              ...
              let cong_stranger = {
                ...
                let p_self = {
                    type: jsPsychHtmlKeyboardResponse, 
                    stimulus: `
                    <p>请您将食指放在相应按键上，准备进入<span style='color: yellow;'>“自我”</span>的正式匹配任务</p>
                  ...
                  let p_friend = {
                    type: jsPsychHtmlKeyboardResponse, 
                    stimulus: `
                    <p>请您将食指放在相应按键上，准备进入<span style='color: yellow;'>“朋友”</span>的正式匹配任务</p>
                    <p> <div style = "color: green"><按任意键开始></div></p>
                    `, 
                    choices: "ALL_KEYS",
                  };
                  ...
                  let p_stranger = {
                    type: jsPsychHtmlKeyboardResponse, 
                    stimulus: `
                    <p>请您将食指放在相应按键上，准备进入<span style='color: yellow;'>“生人”</span>的正式匹配任务</p>
                    <p> <div style = "color: green"><按任意键开始></div></p>
                    `, 
                    choices: "ALL_KEYS",
                  };
