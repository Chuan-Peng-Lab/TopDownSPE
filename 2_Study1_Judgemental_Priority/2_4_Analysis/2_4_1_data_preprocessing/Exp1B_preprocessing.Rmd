...
```{r}
df_raw <- list.files(file.path("./2_4_1_1_RawData"), pattern = "exp1B_.*\\.csv$") %>%
...
write.csv(df,file = "exp1b_long.csv")
```
...
write.csv(df_acc,file = "exp1b_acc_wide.csv")
```
